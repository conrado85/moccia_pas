...
export default function HeroSections({ tarjetas, cabecera }: CuerpoProps) {
  return (
    <section className="w-full max-w-7xl flex flex-col mx-auto pt-10 pb-5 px-4">
      <div>
        <p className="py-2 text-sm text-brand-blue">{cabecera.volanta}</p>

        <h2 className="text-2xl lg:text-3xl font-bold text-brand-blue mb-3">
          {cabecera.titulo}
        </h2>
        <p className=" text-brand-blue mb-10">{cabecera.copete}</p>
      </div>
